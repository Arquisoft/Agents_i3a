 ...
 * 
 */
package es.uniovi.asw.agents_i3a.databaseTests;
...
import es.uniovi.asw.agents_i3a.dbmanagement.Database;
...
@SpringBootTest(classes = {
		Application.class }) @RunWith(SpringJUnit4ClassRunner.class) public class DatabaseTest {
	...
	@Autowired private Database dat;
